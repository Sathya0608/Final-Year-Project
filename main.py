...
with header:
    ...
    st.markdown("### In this, We are going to predict a Disease by getting Symptoms from a User.")
...
with dataset:
    ...
    if st.button("View DataSet"):
        data = pd.read_csv("C:\\Users\\Sathya\\Documents\\Project\\sampletraining.csv")
        st.write(data)
...
with classification:
    ...
    if st.button("CNN"):
        ...
        testing = pd.read_csv("C:\\Users\\Sathya\\Documents\\Project\\sample_testing.csv")
